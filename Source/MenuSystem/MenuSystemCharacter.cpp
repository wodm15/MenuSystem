...
void AMenuSystemCharacter::JoinGameSession()
{
    ...
    OnlineSessionInterface->FindSessions(*PlayerId, SessionSearch.ToSharedRef());


}
void AMenuSystemCharacter::OnCreateSessionComplete(FName SessionName, bool bWasSucessful)
{
	if(bWasSucessful)
	{
        if(GEngine)
